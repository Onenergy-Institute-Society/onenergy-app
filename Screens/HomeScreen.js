...
const CustomDrawerContentComponent = (props) => {
    ...
    return (
        <SafeAreaView style={{flex:1, backgroundColor: colors.bodyBg}}>
            <ScrollView
                {...props}
                contentContainerStyle={{backgroundColor: colors.bodyBg}}>
                <ImageBackground
                    ...
                    {user?
                        ...
                        {user.membership.length > 0 ?
                            <Text style={{color:"#fff", padding:20}}>{user.membership[0].plan.name}</Text>
                            : null}
                        </>
                        :null}
                </ImageBackground>
            ...
            <View style={{marginBottom:verticalScale(25),padding: 15, borderTopWidth: 1, borderTopColor: '#ccc'}}>
                {user?
                    <TouchableOpacity
