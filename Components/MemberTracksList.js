          ...
          >
            <ImageBackground
              ...
              imageStyle={{
                ...
                borderBottomLeftRadius: showPlayer ? 0 : s(9),
                borderBottomRightRadius: showPlayer ? 0 : s(9),
              }}
            >
                ...
                {item.reminder_enable ? (
                  ...
                  >
                    <SvgBell
                      ...
                      style={{ marginRight: s(5) }}
                    />
                    <Text style={styles.duration}>{item.reminder_time}</Text>
                  </View>
                ) : null}
              </View>
          ...
          {showPlayer ? (
            <>
              <AudioPlayerRoutine
                ...
                setMessageBarDisplay={setMessageBarDisplay}
      ...
      >
        ...
        >
          <View style={styles.titleBox}>
            ...
            <Text style={[styles.duration, { color: "grey" }]}>
              {new Date(totalDuration * 1000).toISOString().substring(14, 19)}
            </Text>
          </View>
          <View style={styles.subTitleBox}>
