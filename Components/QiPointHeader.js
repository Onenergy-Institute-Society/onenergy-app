...
const QiPointHeader = (screenProps) => {
    ...
    return (
        <View style={{flexDirection:"row", justifyContent:"flex-end", alignItems:"center", marginRight:scale(15)}}>
            <FastImage source={require('../assets/images/icon-ray.png')} style={{width:16, height:16, marginRight:scale(2)}} />
            <AnimatedNumber style={{color:colors.headerColor, fontFamily:"MontserratAlternates-Regular", fontWeight:"bold"}} value={progressReducer} />
        </View>
    );
};
